...
const RESOURCE_SLUG = 'claude-code-reporting-guide'
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <h1 className="text-4xl lg:text-5xl font-serif leading-[1.1] text-slate mb-6 animate-fade-in-up stagger-1">
                  Claude Code does your reporting.
                </h1>
                <div className="max-w-lg flex items-stretch animate-fade-in-up stagger-2">
                  ...
                  <p className="text-lg leading-[1.6] text-coral-accessible pl-6">
                    A 9-step guide to replacing manual status reports with automated dashboards. Includes a ready-to-use prompt template and a worked example.
                  </p>
                </div>
              </div>
                    ...
                    <a
                      ...
                      onClick={() => {
                        if (typeof window !== 'undefined' && window.dataLayer) {
                          window.dataLayer.push({
                            event: 'file_download',
                            file_name: 'claude-code-reporting-guide.pdf',
                            resource: RESOURCE_SLUG,
                          })
                        }
                      }}
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              ...
              <p className="text-center text-slate/70 max-w-2xl mx-auto mb-14">
                Nine steps from blank screen to live dashboard. Each builds on the last.
              </p>
            </ScrollReveal>
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                {
                  label: 'Prepare',
                  items: ['Define your reporting requirements', 'Map your data sources', 'Write your brief for Claude'],
                  note: 'Get clear before you build.',
                },
                {
                  label: 'Build',
                  items: ['Claude writes the implementation plan', 'Review and approve the approach', 'Get Claude to review its own plan'],
                  note: 'Fix it on paper, not in code.',
                },
                {
                  label: 'Ship',
                  items: ['Claude builds your dashboard', 'Verify against your requirements', 'Go live. No more manual reporting.'],
                  note: 'Typically 20 minutes end to end.',
                },
              ].map((tier) => (
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              <p className="text-lg text-slate/70 leading-relaxed">
                This guide comes from building real reporting dashboards for professional services firms. The prompt template, the review step, the data source mapping: all tested on production systems.
              </p>
          ...
          <section className="py-20 px-6 lg:px-8 bg-slate">
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="text-3xl font-serif text-white mb-4">
                Stop copying numbers into spreadsheets every Monday
              </h2>
              <p className="text-lg text-white/70 mb-8">
                Nine steps. One PDF. Twenty minutes to a live dashboard.
              </p>
              <a
                href="#top"
                onClick={(e) => {
