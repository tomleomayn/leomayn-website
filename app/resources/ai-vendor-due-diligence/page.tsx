...
const RESOURCE_SLUG = 'ai-vendor-due-diligence'
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <h1 className="text-4xl lg:text-5xl font-serif leading-[1.1] text-slate mb-6 animate-fade-in-up stagger-1">
                  The invisible decision in every AI purchase.
                </h1>
              ...
              <div className="animate-fade-in-up stagger-2">
                {status === 'success' && downloadUrl ? (
                  <div className="bg-white border border-steel/20 rounded-lg p-8 text-center">
                    ...
                    <h2 className="text-2xl font-serif text-slate mb-3">Your document is ready</h2>
                    ...
                    <a
                      ...
                      onClick={() => {
                        if (typeof window !== 'undefined' && window.dataLayer) {
                          window.dataLayer.push({
                            event: 'file_download',
                            file_name: 'ai-vendor-due-diligence.pdf',
                            resource: RESOURCE_SLUG,
                          })
                        }
                      }}
                  ...
                  <div className="bg-white border border-steel/20 rounded-lg p-8">
                    <h2 className="text-xl font-serif text-slate mb-2">Get the document</h2>
                    <p className="text-sm text-slate/70 mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      >
                        {status === 'submitting' ? 'Preparing download...' : 'Download the document'}
                      </button>
                    </form>
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              ...
              <p className="text-center text-slate/70 max-w-2xl mx-auto mb-14">
                Two parts. The first tells you what sits underneath. The second gives you the questions to ask.
              </p>
            </ScrollReveal>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                {
                  label: 'Part 1: The model providers',
                  items: [
                    'Independent profiles of OpenAI, Anthropic, Google, Meta, Mistral, xAI, and DeepSeek',
                    'Six dimensions per provider: data handling, training provenance, corporate structure, environmental impact, content policy, organisational stability',
                    'Summary comparison table across all seven',
                  ],
                  note: 'Every claim sourced. 109 references.',
                },
                {
                  label: 'Part 2: Your negotiating power',
                  items: [
                    'Seven questions to ask your AI vendors directly',
                    'Where contractual protections actually exist and where they do not',
                    'How to evaluate model provider risk in your procurement process',
                  ],
                  note: 'Practical. No theory.',
                },
              ].map((tier) => (
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              <p className="text-lg text-slate/70 leading-relaxed">
                This document was written for business leaders evaluating AI tools and platforms. It covers the decisions that sit underneath your vendor relationship and gives you the language to ask better questions.
              </p>
          ...
          <section className="py-20 px-6 lg:px-8 bg-slate">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg text-white/70 mb-8">
                Seven providers. Six dimensions. One document.
              </p>
              <a
                href="#top"
                onClick={(e) => {
