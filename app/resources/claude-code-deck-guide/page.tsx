...
const RESOURCE_SLUG = 'claude-code-deck-guide'

export default function DeckGuidePage() {
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <h1 className="text-4xl lg:text-5xl font-serif leading-[1.1] text-slate mb-6 animate-fade-in-up stagger-1">
                  The setup guide for building branded decks with Claude Code.
                </h1>
                <div className="max-w-lg flex items-stretch animate-fade-in-up stagger-2">
                  ...
                  <p className="text-lg leading-[1.6] text-coral-accessible pl-6">
                    Config, component vocabulary, and the export pipeline. Everything you need to go from brief to branded PDF.
                  </p>
                </div>
              </div>
              ...
              <div className="animate-fade-in-up stagger-2">
                {status === 'success' && downloadUrl ? (
                  <div className="bg-white border border-steel/20 rounded-lg p-8 text-center">
                    ...
                    <h2 className="text-2xl font-serif text-slate mb-3">Your guide is ready</h2>
                    ...
                    <a
                      ...
                      onClick={() => {
                        if (typeof window !== 'undefined' && window.dataLayer) {
                          window.dataLayer.push({
                            event: 'file_download',
                            file_name: 'claude-code-deck-guide.pdf',
                            resource: RESOURCE_SLUG,
                          })
                        }
                      }}
                  ...
                  <div className="bg-white border border-steel/20 rounded-lg p-8">
                    <h2 className="text-xl font-serif text-slate mb-2">Get the guide</h2>
                    <p className="text-sm text-slate/70 mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      >
                        {status === 'submitting' ? 'Preparing download...' : 'Download the guide'}
                      </button>
                    </form>
          ...
          <div className="max-w-4xl mx-auto">
            <ScrollReveal>
              ...
              <p className="text-center text-slate/70 max-w-2xl mx-auto mb-14">
                Three stages. From first setup to reusable brand template to print-ready PDF export.
              </p>
            </ScrollReveal>
              ...
              {[
                {
                  label: 'Setup',
                  items: [
                    'Set up your CLAUDE.md so every deck matches your brand automatically',
                    'The four inputs you need before you start',
                    'A copy-paste config block with colours, fonts, and layout rules',
                  ],
                  note: 'Ten minutes of setup saves hours.',
                },
                {
                  label: 'Build',
                  items: [
                    'The component vocabulary: speak Claude\'s language and get the right slide first time',
                    'Slide types, backgrounds, and layout components with descriptions',
                    'How to give feedback that Claude acts on correctly',
                  ],
                  note: 'The shared language that makes it work.',
                },
                {
                  label: 'Export',
                  items: [
                    'The Playwright export pipeline with copy-paste Python snippet',
                    'Seven gotchas from 13 documented failures',
                    'Print CSS, font loading, and the visual review checklist',
                  ],
                  note: 'Where most people get stuck. Solved.',
                },
              ].map((tier) => (
          ...
          <div className="max-w-3xl mx-auto text-center">
            <ScrollReveal>
              <p className="text-lg text-slate/70 leading-relaxed">
                Every technique is pulled from a working system. Branded board decks, client presentations, and LinkedIn carousels, all built with Claude Code and exported to PDF.
              </p>
          ...
          <section className="py-20 px-6 lg:px-8 bg-slate">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-lg text-white/70 mb-8">
                Brief to branded PDF. One guide covers the whole pipeline.
              </p>
              <a
                href="#top"
                onClick={(e) => {
