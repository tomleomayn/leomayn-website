...
export default function AIReadinessPage() {
  const articleSchema = {
    ...
    'keywords': ['AI readiness', 'professional services', 'operational readiness', 'AI implementation'],
    'author': {
      '@type': 'Organization',
      'name': 'Leomayn',
          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <div className="max-w-2xl flex items-stretch animate-fade-in-up stagger-1">
              ...
              <p className="text-xl leading-[1.6] text-coral-accessible pl-6">
                Most professional services firms have tried AI tools. Few have
                the operational foundations to make them stick. Readiness is not
                about choosing the right model. It is about understanding the
                work underneath it.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-slate">
              ...
              <ScrollReveal delay={0.15}>
                <p>
                  Across professional services, the pattern repeats: firms invest
                  in AI tools, run pilots that show promise, then struggle to move
                  beyond a handful of enthusiastic users. The technology works. The
                  organisation around it does not.
                </p>
              </ScrollReveal>
            </div>
            ...
            <ScrollReveal delay={0.2}>
              <div className="grid md:grid-cols-3 gap-6 my-12">
                <div className="bg-pearl rounded-lg p-8 text-center">
                  ...
                  <p className="text-sm text-slate/70">of accounting firms report using AI tools</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal delay={0.1}>
              <p className="text-lg leading-relaxed text-slate mb-12">
                Across the professional services sector, the same four gaps
                appear when firms move from experimenting with AI to relying on
                it. Each one is invisible from a technology perspective but
                obvious from an operational one.
              </p>
            </ScrollReveal>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <ScrollReveal delay={0.2}>
                <div className="bg-white border border-steel rounded-lg p-8 h-full">
                  ...
                  <p className="text-base leading-relaxed text-slate/70">
                    Most firms cannot tell you whether their AI outputs are good
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal delay={0.1}>
              <div className="mb-12">
                ...
                <p className="text-lg leading-relaxed text-slate mb-6">
                  MTD deadlines are driving urgency, but the readiness gap is
                  upstream. Recovery rates sit at 82% and nobody can explain why.
                  Five systems hold client data with no single source of truth.
                  Firms are buying AI tools to solve problems they have not yet
                  diagnosed.
                </p>
            ...
            <ScrollReveal delay={0.15}>
              <div className="mb-12">
                ...
                <p className="text-lg leading-relaxed text-slate mb-6">
                  Lock-up averages 142 days against a best-in-class benchmark of
                  45. Two-thirds of firms describe themselves as being in
                  &ldquo;automation purgatory&rdquo; &mdash; tools deployed, value elusive. The
                  issue is not the contract review AI. It is the process debt
                  underneath it.
                </p>
                <div className="bg-white border-l-[3px] border-rock rounded-r-lg p-6">
                  <p className="text-base leading-relaxed text-slate">
                    <strong>The readiness question:</strong> When a senior associate
                    leaves, does their client knowledge leave with them? If yes,
            ...
            <ScrollReveal delay={0.2}>
              <div>
                ...
                <p className="text-lg leading-relaxed text-slate mb-6">
                  Utilisation sits at 69% against a 75% target. Sales teams spend
                  30% of their time on admin rather than selling. The instinct is
                  to buy a copilot. The readiness step is to understand why admin
                  takes so long and whether the process is worth keeping at all.
                </p>
                <div className="bg-white border-l-[3px] border-rock rounded-r-lg p-6">
                  <p className="text-base leading-relaxed text-slate">
            ...
            <div className="space-y-6 text-lg leading-relaxed text-slate">
              ...
              <ScrollReveal delay={0.15}>
                <p>
                  ...
                  most value in your firm and what needs to be true before you
                  deploy it.
                </p>
              </ScrollReveal>
              <ScrollReveal delay={0.2}>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <ScrollReveal delay={0.1}>
              <p className="text-xl font-sans leading-relaxed text-white mb-8">
                ...
                your firm and what to fix first.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
