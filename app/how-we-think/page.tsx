      ...
      <main className="min-h-screen">
        ...
        <section className="bg-pearl py-24 px-6 lg:px-8 relative overflow-hidden">
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            {/* Brain-lightning - Top Right */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="absolute right-4 top-4 w-40 h-40 lg:w-48 lg:h-48 opacity-[0.08] pointer-events-none" style={{ fill: '#f7c9c0' }}>
            ...
            {/* Gears - Bottom Left */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="absolute left-4 bottom-4 w-36 h-36 lg:w-44 lg:h-44 opacity-[0.08] pointer-events-none" style={{ fill: '#f7c9c0' }}>
              <path d="M10.73,10.3l1.84,1.06,1-1.73-1.84-1.06c.17-.5,.28-1.02,.28-1.57s-.11-1.07-.28-1.57l1.84-1.06-1-1.73-1.84,1.06c-.71-.8-1.65-1.38-2.73-1.6V0h-2V2.1c-1.08,.22-2.02,.8-2.73,1.6l-1.84-1.06-1,1.73,1.84,1.06c-.17,.5-.28,1.02-.28,1.57s.11,1.07,.28,1.57l-1.84,1.06,1,1.73,1.84-1.06c.71,.8,1.65,1.38,2.73,1.6v2.1h2v-2.1c1.08-.22,2.02-.8,2.73-1.6Zm-6.73-3.3c0-1.65,1.35-3,3-3s3,1.35,3,3-1.35,3-3,3-3-1.35-3-3Zm18,10c0-.55-.11-1.07-.28-1.57l1.84-1.06-1-1.73-1.84,1.06c-.71-.8-1.65-1.38-2.73-1.6v-2.1h-2v2.1c-1.08,.22-2.02,.8-2.73,1.6l-1.84-1.06-1,1.73,1.84,1.06c-.17,.5-.28,1.02-.28,1.57s.11,1.07,.28,1.57l-1.84,1.06,1,1.73,1.84-1.06c.71,.8,1.65,1.38,2.73,1.6v2.1h2v-2.1c1.08-.22,2.02-.8,2.73-1.6l1.84,1.06,1-1.73-1.84-1.06c.17-.5,.28-1.02,.28-1.57Zm-5,3c-1.65,0-3-1.35-3-3s1.35-3,3-3,3,1.35,3,3-1.35,3-3,3Z"/>
            </svg>

            {/* Circle-nodes - Top Left */}
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="absolute left-4 top-20 w-32 h-32 lg:w-40 lg:h-40 opacity-[0.08] pointer-events-none" style={{ fill: '#f7c9c0' }}>
              <path d="M24,4c0-2.206-1.794-4-4-4s-4,1.794-4,4c0,.067,.017,.13,.02,.196L7.386,6.894c-.707-1.133-1.955-1.894-3.386-1.894C1.794,5,0,6.794,0,9s1.794,4,4,4c.802,0,1.547-.243,2.174-.651l6.31,5.784c-.299,.56-.484,1.189-.484,1.867,0,2.206,1.794,4,4,4s4-1.794,4-4c0-1.513-.854-2.816-2.096-3.496l2.127-8.507c2.191-.017,3.969-1.802,3.969-3.997Zm-4-2c1.103,0,2,.897,2,2s-.897,2-2,2-2-.897-2-2,.897-2,2-2Zm-3.386,4.106c.365,.584,.876,1.058,1.482,1.39l-2.126,8.508c-.79,.006-1.524,.245-2.143,.647l-6.31-5.784c.299-.56,.484-1.189,.484-1.867,0-.067-.017-.13-.02-.196l8.634-2.698ZM4,11c-1.103,0-2-.897-2-2s.897-2,2-2,2,.897,2,2-.897,2-2,2Zm12,11c-1.103,0-2-.897-2-2s.897-2,2-2,2,.897,2,2-.897,2-2,2Z"/>
            </svg>
          </div>
        </section>
