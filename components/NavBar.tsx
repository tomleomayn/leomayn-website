      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="relative group">
              <Link
                href="/approach"
                className={`text-sm font-sans flex items-center gap-1 ${isActive('/approach') || isActive('/security-compliance') || isActive('/ai-readiness') || pathname?.startsWith('/ai-planner') ? 'text-slate font-semibold border-b-2 border-coral pb-1' : 'text-slate/70 hover:text-slate nav-link-animated'}`}
              >
                Our Approach
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              ...
              <div className="absolute top-full left-0 mt-2 w-56 bg-white border border-steel rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all overflow-hidden">
                <Link href="/ai-planner" className="block px-4 py-2 text-sm font-sans text-slate/70 hover:text-slate hover:bg-chalk">
                  AI Deployment Planner
                </Link>
                <Link href="/ai-readiness" className="block px-4 py-2 text-sm font-sans text-slate/70 hover:text-slate hover:bg-chalk">
                  AI Readiness
                </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 space-y-2">
            ...
            <Link href="/ai-planner" className="block py-2 text-sm font-sans text-slate pl-4">AI Deployment Planner</Link>
            <Link href="/ai-readiness" className="block py-2 text-sm font-sans text-slate pl-4">AI Readiness</Link>
